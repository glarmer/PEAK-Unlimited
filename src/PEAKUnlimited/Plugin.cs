...
public partial class Plugin : BaseUnityPlugin
{
    ...
    private void Awake()
    {
        ...
        _ui.Init(new List<Option>
        {
            ...
            Option.Float("Hot Dog Chance", ConfigurationHandler.ConfigHotDogChance, 0f, 1f, 0.005f, isDisabled: () => PhotonNetwork.InRoom && GameHandler.GetService<RichPresenceService>().m_currentState != RichPresenceState.Status_Airport),
